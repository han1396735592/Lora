...
//u8* model_select[3]={"节日模式","路灯模式","警察模式"};
...
void Menu_ui(void)
{
	...
	LCD_Clear(WHITE);
	POINT_COLOR=RED;
	Show_Str_Mid(0,33,"公园智能景观灯控制系统",16,240); 
	...
	Show_Str(40+x,45+y,200,16,"模式选择",16,0);
	...
	Show_Str(40+x,215+y,200,16,"显示状态：",16,0);
	...
	while(1)
	{
	  ...
	  if(key==KEY1_PRES||key==KEY0_PRES)
	  {
	  	...
	  	switch(num)
	  	{
	  		...
	  		Show_Str(40+x+10,45+y,200,16,model,16,0);	  
	  		break;		  
	  		case 1: 
